...
class atoms2RobotCached(Atoms.SimulationEvent):
	agentTypeFile = r'/home/alan/projects/atomscrowd/deploy/data/variations/cache/agentTypes/atoms2Robot.agentType'
	eventName = 'atoms2RobotCached'
	agentTypeName = 'atoms2Robot'
	geoPath = ''
	skinPath = ''
	stateMachine = ''
